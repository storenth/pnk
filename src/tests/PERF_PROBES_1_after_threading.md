...
```bash
./src/pnk/__main__.py ./src/tests/big_list.txt  7.25s user 1.95s system 93% cpu 9.828 total
./src/pnk/__main__.py -j 1 ./src/tests/big_list.txt  7.20s user 1.86s system 96% cpu 9.400 total
./src/pnk/__main__.py -j 2 ./src/tests/big_list.txt  2.89s user 0.69s system 95% cpu 3.731 total
./src/pnk/__main__.py -j 4 ./src/tests/big_list.txt  3.82s user 1.72s system 147% cpu 3.764 total
./src/pnk/__main__.py -j 8 ./src/tests/big_list.txt  4.70s user 3.39s system 194% cpu 4.151 total

./src/pnk/__main__.py ./src/tests/big_list.txt  7.32s user 1.91s system 94% cpu 9.756 total
./src/pnk/__main__.py -j 1 ./src/tests/big_list.txt  7.09s user 1.88s system 95% cpu 9.374 total
./src/pnk/__main__.py -j 2 ./src/tests/big_list.txt  3.28s user 1.07s system 116% cpu 3.739 total
./src/pnk/__main__.py -j 4 ./src/tests/big_list.txt  3.74s user 1.07s system 144% cpu 3.340 total
./src/pnk/__main__.py -j 8 ./src/tests/big_list.txt  4.30s user 0.99s system 170% cpu 3.094 total
